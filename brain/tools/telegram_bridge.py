...
def _source_dirs():
    ...
    was why "the Jules and Marlow split" came back empty while Claude found
            ...
            try:
                if not conf.get("chat_id"):
                    ...
                    _send(token, chat,
                          ...
                          "plan. To get something back: “send: the Jules "
                ...
                if part:
                    ...
                    # jules and marlow file" is the commonest thing she
