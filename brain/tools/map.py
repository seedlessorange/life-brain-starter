...
def build():
    ...
    def ws_people(w):
        ...
        # name ("Respond to Marlow"), the next move ("demo for Dad"), the
    ...
    # is what turns a star diagram into a graph — "Marlow connects the
  ...
  if(n.kind === 'ws'){
    ...
    ap.onclick = function(ev){ ev.stopPropagation();
      mdlgOpen('Link a person \\u2014 ' + n.name, 'Who (exact name)',
               'Dad, Teagan, Maman\\u2026', null, null, 'Link them',
        function(v1){
